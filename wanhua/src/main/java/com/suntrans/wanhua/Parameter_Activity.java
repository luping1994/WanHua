...
//            }
            ...
            System.out.println("RSAddr="+RSAddr);
...
//                        data.get(1).put("Value", String.valueOf(ydegree) + " °");  //y轴角度
                ...
                {//ab68 000a f0 06 0305 00 08 8d680d0a
                    //ab68000ff006 0305 00 08 8d680d0a
                    //ab680013f006 0305 00 40 8d5e0d0a
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SoundPoolMap.put(3, soundPool.load(Parameter_Activity.this,R.raw.voice_smoke,1));   //加载烟雾报警文件

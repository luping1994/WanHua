 ...
 */
public class DefaultRoomAdapter extends  RecyclerView.Adapter <DefaultRoomAdapter.MyViewHolder>{
...
//    private  SmartSwitch datas;
    ...
    Bitmap dot_off;
    Bitmap dot_on;
    public DefaultRoomAdapter(Context context, ArrayList<Map<String,Object>> datas){
...
//            imageView.setImageBitmap(TextUtils.equals((String)datas.get(position).get("State"),"0")?bitmap_off:bitmap_on);

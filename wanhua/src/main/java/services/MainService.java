...
//        sixSensorPort= Integer.valueOf(sharedPreferences.getString("sixSensorPort", "8086"));
    ...
    public void onCreate() {
        ...
        sixSensorIp = MyApplication.getSharedPreferences().getString("sixSensorIp","61.235.65.160");
        sixSensorPort = MyApplication.getSharedPreferences().getInt("sixSensorPort",8997);
//
